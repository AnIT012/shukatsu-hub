...
export function buildSampleApplications(): Application[] {
  ...
  const app: Application = {
    ...
    steps: [
      { id: `${SAMPLE_APP_ID}-s1`, kind: "entry", name: "エントリー", dueAt: dPlus(0), heldAt: null, status: "done", location: "", memo: "" },
      { id: `${SAMPLE_APP_ID}-s2`, kind: "es", name: "ES提出", dueAt: dPlus(2), heldAt: null, status: "in_progress", location: "", memo: "丸をタップで状態を切り替えられます" },
      { id: `${SAMPLE_APP_ID}-s3`, kind: "web_test", name: "Webテスト", dueAt: dPlus(5), heldAt: null, status: "not_started", location: "", memo: "" },
